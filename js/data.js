...
const TIPOS = {
  1: { nombre: "El Organizador", miedo: "No ser perfecto", motivacion: "Ser bueno, íntegro, correcto", centro: "Visceral — instintivo", transformacion: "Del perfeccionismo a la alegría", ala_desarrolla: 2, ala_cuesta: 9, integracion: 7, desintegracion: 4, triada: "enfrentan",
       mini_lectura: "Tenés un sentido interno muy afinado de lo que está bien y lo que no — y eso te da dirección en la vida, pero también una exigencia que pocas veces descansa. Cargás con la sensación de que siempre se puede hacer mejor, y eso te mueve y a veces te pesa. Tu luz más genuina es la integridad: cuando actuás desde ahí, generás confianza y estructura en todo lo que tocás. Tu camino es aprender que la alegría no se gana — ya la tenés.",
  ...
  2: { nombre: "El Servidor",    miedo: "No ser querido, ser rechazado", motivacion: "Ser amado y necesario", centro: "Sentimiento — emocional", transformacion: "Del servicio condicionado al altruismo", ala_desarrolla: 1, ala_cuesta: 3, integracion: 4, desintegracion: 8, triada: "acercan",
       mini_lectura: "Sos de las personas que conectan de verdad: te importa lo que le pasa al otro, y eso se nota. Tenés una capacidad natural para leer lo que los demás necesitan, y moverte hacia ahí incluso antes de que te lo pidan. Pero hay algo que el test probablemente empezó a mostrar: que dar tanto a veces viene de un lugar que también pide algo a cambio. Tu transformación está en descubrir que podés ser querido sin tener que ganártelo cada vez.",
  ...
  3: { nombre: "El Realizador",  miedo: "Fracasar, no ser valioso", motivacion: "Ser admirado y exitoso", centro: "Sentimiento — emocional", transformacion: "De la imagen a la autenticidad", ala_desarrolla: 2, ala_cuesta: 4, integracion: 6, desintegracion: 9, triada: "enfrentan",
       mini_lectura: "Sos alguien orientado al resultado, con energía para arrancar y terminar proyectos, y una imagen que construiste con esfuerzo. La gente te ve como decidido, capaz, alguien que puede. Pero hay una pregunta que el tipo 3 casi nunca se hace en voz alta: ¿quién soy yo cuando no estoy logrando nada? Tu luz más real no está en lo que hacés — está en lo que sos cuando nadie te mira.",
  ...
  4: { nombre: "El Creativo",    miedo: "Ser común, igual a todos", motivacion: "Expresarse con profundidad y belleza", centro: "Sentimiento — emocional", transformacion: "Del mundo interior a la acción", ala_desarrolla: 5, ala_cuesta: 3, integracion: 1, desintegracion: 2, triada: "aislan",
       mini_lectura: "Vivís la vida con una intensidad que pocas personas comprenden. Tenés un mundo interior muy rico, una sensibilidad para lo bello y lo profundo, y una necesidad auténtica de expresarte de manera única. A veces esa profundidad se convierte en distancia — del presente, de los demás, de la acción. Tu mayor desafío no es sentir más: es hacer algo concreto con todo lo que ya sentís.",
  ...
  5: { nombre: "El Observador",  miedo: "Ser ignorante, no entender", motivacion: "Saber, ser competente", centro: "Mental — pensamiento", transformacion: "De la sabiduría acumulada a la acción", ala_desarrolla: 4, ala_cuesta: 6, integracion: 8, desintegracion: 7, triada: "aislan",
       mini_lectura: "Observás antes de actuar, pensás antes de hablar, y preferís entender el sistema completo antes de dar un paso. Esa capacidad de análisis es uno de tus recursos más genuinos. Pero hay un costo que el tipo 5 suele pagar sin darse cuenta: el mundo pasa mientras seguís procesando. Tu transformación no pasa por saber más — pasa por animarte a estar presente aunque no tengas todo resuelto.",
  ...
  6: { nombre: "El Colaborador", miedo: "No estar seguro, que algo malo pase", motivacion: "Apoyo, seguridad y estructura", centro: "Mental — pensamiento", transformacion: "De la lealtad a la paz interior", ala_desarrolla: 5, ala_cuesta: 7, integracion: 9, desintegracion: 3, triada: "acercan",
       mini_lectura: "Sos de los que permanecen: leal, responsable, con una gran capacidad para sostener vínculos y proyectos a lo largo del tiempo. También sos alguien que vive con más alerta interna que los demás — evaluando el entorno, anticipando lo que podría salir mal. Esa antena sensible te protegió mucho. Y también te cansó. Tu camino es empezar a confiar en vos mismo con la misma intensidad con que confiás en los demás.",
  ...
  7: { nombre: "El Entusiasta",  miedo: "El dolor y el sufrimiento", motivacion: "Ser feliz, disfrutar, vivir experiencias", centro: "Mental — pensamiento", transformacion: "De la alegría dispersa a la sabiduría", ala_desarrolla: 8, ala_cuesta: 6, integracion: 5, desintegracion: 1, triada: "acercan",
       mini_lectura: "Tenés una energía genuina que hace que la vida a tu alrededor se sienta más viva. Buscás experiencias, conectás ideas, abrís puertas. Pero hay algo que el tipo 7 rara vez se detiene a mirar: lo que queda cuando el entusiasmo baja. Tu sabiduría más profunda no está en el próximo plan — está en lo que encontrás cuando te quedás quieto el tiempo suficiente.",
  ...
  8: { nombre: "El Luchador",    miedo: "Ser herido o dominado", motivacion: "Protegerse y decidir su camino", centro: "Visceral — instintivo", transformacion: "De la justicia propia al altruismo", ala_desarrolla: 7, ala_cuesta: 9, integracion: 2, desintegracion: 5, triada: "enfrentan",
       mini_lectura: "Tenés presencia: no es algo que construiste, es algo que emanás. Sabés moverte en situaciones difíciles, tomás decisiones, protegés a los que querés. Pero el tipo 8 suele pagar un precio silencioso: mostrar vulnerabilidad parece peligroso, entonces se guarda. Lo que más puede transformarte no es más fuerza — es dejar que alguien te vea en tu parte blanda.",
  ...
  9: { nombre: "El Pacificador", miedo: "El caos y el conflicto", motivacion: "Paz y armonía", centro: "Visceral — instintivo", transformacion: "De la paz evitativa a la fe en sí mismo", ala_desarrolla: 1, ala_cuesta: 8, integracion: 3, desintegracion: 6, triada: "aislan",
       mini_lectura: "Sos una presencia que calma: tenés una capacidad genuina para ver todos los lados, para no juzgar, para sostener la armonía. Pero el tipo 9 carga algo menos visible — la dificultad de saber qué quiere vos, más allá de lo que quieren los demás. Tu presencia en el mundo importa, pero para que los demás la reciban, primero tenés que animarte a ocupar tu propio lugar.",
