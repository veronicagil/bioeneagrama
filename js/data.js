...
const TIPOS = {
  1: { nombre: "El Organizador", miedo: "No ser perfecto", motivacion: "Ser bueno, íntegro, correcto", centro: "Visceral — instintivo", transformacion: "Del perfeccionismo a la alegría", ala_desarrolla: 2, ala_cuesta: 9, integracion: 7, desintegracion: 4, triada: "enfrentan",
       mini_lectura: "El Organizador tiene un sentido interno muy afinado de lo que está bien y lo que no — eso le da dirección en la vida, pero también una exigencia que pocas veces descansa. Carga con la sensación de que siempre se puede hacer mejor. Su mayor recurso es la integridad: cuando actúa desde ahí, genera confianza y estructura en todo lo que toca. Su camino es aprender que la alegría no se gana — ya la tiene.",
       orientacion: "El trabajo del Organizador comienza por observar cuándo la exigencia interna se convierte en un obstáculo para disfrutar y conectar. Integrar la compasión hacia los propios errores y la espontaneidad es su camino hacia la alegría genuina.",
       resena: "Energía orientada a la corrección y la integridad. Tiene una brújula interna muy clara de lo que está bien — y puede volverse muy exigente consigo mismo y con los demás cuando algo no cumple ese estándar." },
  2: { nombre: "El Servidor",    miedo: "No ser querido, ser rechazado", motivacion: "Ser amado y necesario", centro: "Sentimiento — emocional", transformacion: "Del servicio condicionado al altruismo", ala_desarrolla: 1, ala_cuesta: 3, integracion: 4, desintegracion: 8, triada: "acercan",
       mini_lectura: "El Servidor conecta de verdad: le importa lo que le pasa al otro, y eso se nota. Tiene una capacidad natural para leer lo que los demás necesitan y moverse hacia ahí incluso antes de que se lo pidan. Pero dar tanto a veces viene de un lugar que también pide algo a cambio. Su transformación está en descubrir que puede ser querido sin tener que ganárselo cada vez.",
       orientacion: "El trabajo del Servidor comienza por observar cuándo el cuidado hacia el otro esconde una necesidad propia de validación. Integrar el autocuidado y aprender a recibir sin condiciones es su camino hacia el amor verdadero — incluido el propio.",
       resena: "Energía orientada al vínculo y al cuidado. Necesita sentirse querido y necesario — y puede perder de vista sus propias necesidades mientras atiende las de todos los demás." },
  3: { nombre: "El Realizador",  miedo: "Fracasar, no ser valioso", motivacion: "Ser admirado y exitoso", centro: "Sentimiento — emocional", transformacion: "De la imagen a la autenticidad", ala_desarrolla: 2, ala_cuesta: 4, integracion: 6, desintegracion: 9, triada: "enfrentan",
       mini_lectura: "El Realizador está orientado al resultado, con energía para arrancar y terminar proyectos, y una imagen que construyó con esfuerzo. Los demás lo ven como decidido, capaz, alguien que puede. Pero hay una pregunta que el Realizador casi nunca se hace en voz alta: ¿quién soy cuando no estoy logrando nada? Su luz más real no está en lo que hace — está en lo que es cuando nadie lo mira.",
       orientacion: "El trabajo del Realizador comienza por detectar cuándo la imagen reemplaza a la autenticidad. Integrar la capacidad de estar sin hacer y de conectar con lo que se siente más allá de los resultados es su camino hacia una identidad genuina.",
       resena: "Energía orientada al logro y la imagen. Tiene una gran capacidad para alcanzar metas y proyectar confianza — y puede confundir lo que logra con lo que verdaderamente es." },
  4: { nombre: "El Creativo",    miedo: "Ser común, igual a todos", motivacion: "Expresarse con profundidad y belleza", centro: "Sentimiento — emocional", transformacion: "Del mundo interior a la acción", ala_desarrolla: 5, ala_cuesta: 3, integracion: 1, desintegracion: 2, triada: "aislan",
       mini_lectura: "El Creativo vive con una intensidad que pocas personas comprenden. Tiene un mundo interior muy rico, una sensibilidad para lo bello y lo profundo, y una necesidad auténtica de expresarse de manera única. A veces esa profundidad se convierte en distancia — del presente, de los demás, de la acción. Su mayor desafío no es sentir más: es hacer algo concreto con todo lo que ya siente.",
       orientacion: "El trabajo del Creativo comienza por observar cuándo la intensidad emocional se convierte en un lugar donde quedarse. Integrar la acción concreta y la capacidad de estar presente — incluso en lo cotidiano — es su camino hacia la realización.",
       resena: "Energía orientada a la profundidad y la expresión. Tiene una sensibilidad muy afinada para lo bello y lo significativo — y puede quedarse atrapado en la intensidad de su mundo interior." },
  5: { nombre: "El Observador",  miedo: "Ser ignorante, no entender", motivacion: "Saber, ser competente", centro: "Mental — pensamiento", transformacion: "De la sabiduría acumulada a la acción", ala_desarrolla: 4, ala_cuesta: 6, integracion: 8, desintegracion: 7, triada: "aislan",
       mini_lectura: "El Observador analiza antes de actuar, piensa antes de hablar, y prefiere entender el sistema completo antes de dar un paso. Esa capacidad de análisis es uno de sus recursos más genuinos. Pero hay un costo que el Observador suele pagar sin darse cuenta: el mundo pasa mientras sigue procesando. Su transformación no pasa por saber más — pasa por animarse a estar presente aunque no tenga todo resuelto.",
       orientacion: "El trabajo del Observador comienza por notar cuándo el análisis reemplaza a la participación. Integrar la presencia, el contacto y la expresión de lo que siente es su camino hacia una vida más plena.",
       resena: "Energía orientada al conocimiento y la autonomía. Analiza y comprende antes de actuar — y puede volverse tan reservado que el mundo pase sin que se involucre en él." },
  6: { nombre: "El Colaborador", miedo: "No estar seguro, que algo malo pase", motivacion: "Apoyo, seguridad y estructura", centro: "Mental — pensamiento", transformacion: "De la lealtad a la paz interior", ala_desarrolla: 5, ala_cuesta: 7, integracion: 9, desintegracion: 3, triada: "acercan",
       mini_lectura: "El Colaborador es de los que permanecen: leal, responsable, con una gran capacidad para sostener vínculos y proyectos a lo largo del tiempo. También vive con más alerta interna que los demás — evaluando el entorno, anticipando lo que podría salir mal. Esa antena sensible lo protegió mucho. Y también lo cansó. Su camino es empezar a confiar en sí mismo con la misma intensidad con que confía en los demás.",
       orientacion: "El trabajo del Colaborador comienza por observar cuándo el miedo dicta las decisiones en lugar de la confianza propia. Integrar la fe en sí mismo y actuar sin buscar validación externa es su camino hacia la paz interior.",
       resena: "Energía orientada a la seguridad y la lealtad. Es confiable y responsable, con una antena muy sensible para detectar amenazas — y puede paralizarse ante la duda o el miedo." },
  7: { nombre: "El Entusiasta",  miedo: "El dolor y el sufrimiento", motivacion: "Ser feliz, disfrutar, vivir experiencias", centro: "Mental — pensamiento", transformacion: "De la alegría dispersa a la sabiduría", ala_desarrolla: 8, ala_cuesta: 6, integracion: 5, desintegracion: 1, triada: "acercan",
       mini_lectura: "El Entusiasta tiene una energía genuina que hace que la vida a su alrededor se sienta más viva. Busca experiencias, conecta ideas, abre puertas. Pero hay algo que el Entusiasta rara vez se detiene a mirar: lo que queda cuando el entusiasmo baja. Su sabiduría más profunda no está en el próximo plan — está en lo que encuentra cuando se queda quieto el tiempo suficiente.",
       orientacion: "El trabajo del Entusiasta comienza por notar cuándo la búsqueda de nuevas experiencias es en realidad una huida del malestar. Integrar la capacidad de quedarse con lo que duele y profundizar en vez de dispersarse es su camino hacia la sabiduría.",
       resena: "Energía orientada a la experiencia y la alegría. Tiene una vitalidad genuina y una capacidad real de ver posibilidades donde otros ven problemas — y puede evitar el dolor saltando siempre hacia lo siguiente." },
  8: { nombre: "El Luchador",    miedo: "Ser herido o dominado", motivacion: "Protegerse y decidir su camino", centro: "Visceral — instintivo", transformacion: "De la justicia propia al altruismo", ala_desarrolla: 7, ala_cuesta: 9, integracion: 2, desintegracion: 5, triada: "enfrentan",
       mini_lectura: "El Luchador tiene presencia: no es algo que construyó, es algo que emana. Sabe moverse en situaciones difíciles, toma decisiones, protege a los que quiere. Pero el Luchador suele pagar un precio silencioso: mostrar vulnerabilidad parece peligroso, entonces se guarda. Lo que más puede transformarlo no es más fuerza — es dejar que alguien lo vea en su parte blanda.",
       orientacion: "El trabajo del Luchador comienza por observar cuándo la fortaleza se convierte en una barrera para la cercanía y la ternura. Integrar la vulnerabilidad y el cuidado genuino hacia los demás es su camino hacia el altruismo real.",
       resena: "Energía orientada al poder y la protección. Tiene presencia natural y valentía para enfrentar lo difícil — y puede volverse excesivamente intenso o controlador cuando siente que pierde terreno." },
  9: { nombre: "El Pacificador", miedo: "El caos y el conflicto", motivacion: "Paz y armonía", centro: "Visceral — instintivo", transformacion: "De la paz evitativa a la fe en sí mismo", ala_desarrolla: 1, ala_cuesta: 8, integracion: 3, desintegracion: 6, triada: "aislan",
       mini_lectura: "El Pacificador es una presencia que calma: tiene una capacidad genuina para ver todos los lados, para no juzgar, para sostener la armonía. Pero carga algo menos visible — la dificultad de saber qué quiere, más allá de lo que quieren los demás. Su presencia en el mundo importa, pero para que los demás la reciban, primero tiene que animarse a ocupar su propio lugar.",
       orientacion: "El trabajo del Pacificador comienza por observar cuándo la búsqueda de armonía implica borrarse a sí mismo. Integrar la propia voz, los propios deseos y la capacidad de sostenerse en el conflicto es su camino hacia la presencia genuina.",
       resena: "Energía orientada a la armonía y la calma. Tiene una capacidad genuina para ver todos los lados y sostener el equilibrio — y puede olvidarse de sus propias necesidades para evitar el conflicto." }
};
...
const TRIADAS = {
  acercan: {
    nombre: "Tríada del Acercamiento",
    tipos: [2, 6, 7],
    herida: "rechazo",
    clave: "dar un paso hacia atrás"
  },
  enfrentan: {
    nombre: "Tríada del Enfrentamiento",
    tipos: [1, 3, 8],
    herida: "agresión",
    clave: "dar un paso hacia el interior"
  },
  aislan: {
    nombre: "Tríada del Aislamiento",
    tipos: [4, 5, 9],
    herida: "abandono",
